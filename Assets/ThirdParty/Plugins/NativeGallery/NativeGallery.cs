...
public static class NativeGallery
{
	...
	public static void SaveAudioToGallery( byte[] mediaBytes, string album, string filename, MediaSaveCallback callback = null )
	{
		SaveToGallery( mediaBytes, album, filename, MediaType.Audio, callback );
	}

	public static void SaveAudioToGallery( string existingMediaPath, string album, string filename, MediaSaveCallback callback = null )
	{
